...
* Prevalent cases of CHF 
  ...
  * n = 1,271 prevalent cases were excluded, resulting n = 39,766 subjects
...
* The outcome is CHF 
* Among n = 39,766 subjects, there were 7,651 incident cases (19.2%) of CHF 
...
* Among these incident CHF cases, the mean (SD) age of diagnosis was 81.0 (9.2) years. The median age of diagnosis was 82.0 years.
...
ahs_medic_inc2 %>% 
  CreateTableOne(c("CHF_YN", tablevars), strata = "eggs_gram_ea_4", data = ., addOverall = TRUE) %>% 
  print(showAllLevels = TRUE) %>% 
  kableone()
...
mv_mod1 <- coxph(Surv(agein, ageout, inc_CHF) ~ eggs_gram_ea_4 + 
...
* There were no significant interactions between egg and meat intake (p = 0.38)
